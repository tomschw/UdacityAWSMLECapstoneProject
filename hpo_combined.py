...
def main(args):
    ...
    # Create loaders
    train_loader = create_data_loaders(os.environ["SM_CHANNEL_TRAIN"], os.environ["SM_CHANNEL_TRAIN"] + "/gt_6.csv", args.batch_size)
    validation_loader = create_data_loaders(os.environ["SM_CHANNEL_VALID"], os.environ["SM_CHANNEL_VALID"] + "/gt_6.csv", args.batch_size)
    test_loader = create_data_loaders(os.environ["SM_CHANNEL_TEST"], os.environ["SM_CHANNEL_TEST"] + "/gt_6.csv", args.batch_size)
    '''
